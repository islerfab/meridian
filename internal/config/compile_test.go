...
// The weekly-region semantics decided 2026-08-08: weekdays+window+timezone
// form a recurring region; timed events match on overlap; all-day events
// are weekday-governed only. 2026-08-10 is a Monday; Zurich is UTC+2 (CEST)
// in August.
