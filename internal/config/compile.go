...
// weekdays+window+timezone define a recurring region; a timed
...
// plus the provider-ID → logical-key mapping the engine needs to recognize
// configured calendars among discovered ones.
