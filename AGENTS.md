...
Meridian is a Kubernetes-native, declarative calendar sync engine: one-way, rule-based mirrors between Google Calendar and CalDAV, configured as YAML and running as a single stateless pod. Go, single-tenant, MIT.
