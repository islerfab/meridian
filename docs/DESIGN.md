...
2. **Mass-delete guard** — empty or failed source fetch aborts the cycle instead of deleting all shadows (vdirsyncer's emptied-storage guard; watch its false-positive failure mode, vdirsyncer#694).
